...
import 'package:diabetes_care/pages/practitionersPage/practitionerRecommendDietPage/practitioner_diet_page.dart';
...
import '../../pages/practitionersPage/practitionerPatientDietPage/practitioner_patient_diet_page.dart';
...
@AdaptiveAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute(
      page: PractitionerPatientsDietPage,
    ),
    // AutoRoute(
    //   page: PraDietPage,
    // ),
