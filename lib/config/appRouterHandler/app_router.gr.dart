...
class _$AppRouter extends RootStackRouter {
  ...
  final Map<String, PageFactory> pagesMap = {
    ...
    PractitionerPatientsDietRoute.name: (routeData) {
      final args = routeData.argsAs<PractitionerPatientsDietRouteArgs>();
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: PractitionerPatientsDietPage(
          key: args.key,
          praPatientEmailOnPraView: args.praPatientEmailOnPraView,
        ),
      );
    ...
    DietRoute.name: (routeData) {
      final args = routeData.argsAs<DietRouteArgs>();
      return AdaptivePage<dynamic>(
        routeData: routeData,
        child: DietPage(
          key: args.key,
  ...
  List<RouteConfig> get routes => [
        ...
        RouteConfig(
          PractitionerPatientsDietRoute.name,
          path: '/practitioner-patients-diet-page',
        ),
      ];
}
...
/// generated route for
/// [PractitionerPatientsDietPage]
class PractitionerPatientsDietRoute
    extends PageRouteInfo<PractitionerPatientsDietRouteArgs> {
  PractitionerPatientsDietRoute({
    Key? key,
    required String praPatientEmailOnPraView,
  }) : super(
          PractitionerPatientsDietRoute.name,
          path: '/practitioner-patients-diet-page',
          args: PractitionerPatientsDietRouteArgs(
            key: key,
            praPatientEmailOnPraView: praPatientEmailOnPraView,
          ),
        );

  static const String name = 'PractitionerPatientsDietRoute';
}

class PractitionerPatientsDietRouteArgs {
  const PractitionerPatientsDietRouteArgs({
    this.key,
    required this.praPatientEmailOnPraView,
  });
  ...
  @override
  String toString() {
    return 'PractitionerPatientsDietRouteArgs{key: $key, praPatientEmailOnPraView: $praPatientEmailOnPraView}';
  }
}
...
/// generated route for
/// [DietPage]
class DietRoute extends PageRouteInfo<DietRouteArgs> {
  DietRoute({
    Key? key,
    required bool isItFromPatientsView,
    String? praPatientEmailOnPraView,
...
class DietRouteArgs {
  ...
  @override
  String toString() {
    return 'DietRouteArgs{key: $key, isItFromPatientsView: $isItFromPatientsView, praPatientEmailOnPraView: $praPatientEmailOnPraView}';
  }
}
