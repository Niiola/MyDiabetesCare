...
class PraDietPageViewWidget extends StatefulWidget {
  final bool isItFromPatientsView;
  final String? praPatientEmailOnPraView;
  const PraDietPageViewWidget({
    Key? key,
  ...
  @override
  State<PraDietPageViewWidget> createState() => _PraDietPageViewWidgetState();
}

class _PraDietPageViewWidgetState extends State<PraDietPageViewWidget> {
