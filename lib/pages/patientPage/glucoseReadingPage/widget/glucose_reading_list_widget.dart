            ...
            ? Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    double glucoseReadingValue = 0.0;
                    if (glucoseReadingList[index]['glucoseValue'] is int) {
                      glucoseReadingValue =
                          glucoseReadingList[index]['glucoseValue'].toDouble();
                    } else {
                     glucoseReadingValue = glucoseReadingList[index]['glucoseValue'];
                    }
                    ...
                    return CustomGlucoseReadingItemWidget(
                      ...
                      glucoseLevel: glucoseReadingValue,
                      imagePath: imagePath,
                      time: time,
