        ...
        for (var glucoseListElement in glucoseList) {
          if (glucoseListElement['email'] == email) {
            ...
            if (userGlucoseReading.isNotEmpty) {
              ...
              debugPrint(
                  'last glucose reading is ${lastGlucoseReading['glucoseValue']}');
              if (lastGlucoseReading['glucoseValue'] is int) {
                lastGlucoseLevelReading =
                    lastGlucoseReading['glucoseValue'].toDouble();
              } else {
