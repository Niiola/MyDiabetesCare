...
class _AuthenticationRegisterWidgetState
  ...
  bool isThereErrorForRegisterPhoneNumberField = false;
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: hintTextStyle,
                          errorText:
                              isThereErrorForRegisterPhoneNumberField == true
                        ...
                        onChanged: (value) {
                          if (phoneNumberController.text.isNotEmpty &&
                              isThereErrorForRegisterPhoneNumberField == true) {
                            setState(() {
                              isThereErrorForRegisterPhoneNumberField =
                                  !isThereErrorForRegisterPhoneNumberField;
                            });
                          } else {
                            setState(() {
                              isThereErrorForRegisterPhoneNumberField = false;
                            });
                          }
                        },
                      ),
  ...
  Future<void> validateRequiredFieldsAndRegisterUser() async {
    ...
    if (registerPhoneNumber.isEmpty) {
      setState(() {
        isThereErrorForRegisterPhoneNumberField = true;
      });
    } else {
